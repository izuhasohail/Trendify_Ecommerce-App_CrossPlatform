...
const InputField = ({
  ...
  return (
    <>
      <div
        className={
          isInputFocus ? "log-inputfield signiu-input-focus" : "log-inputfield"
        }
      >
...
const Login = () => {
  ...
  const isPasswordValid = (password) => {
    ...
    return lengthRegex.test(password) && characterRegex.test(password);
  };
  ...
  const handleSignupSubmit = async (e) => {
    ...
    if (!phonePattern.test(signupFormData.phoneno)) {
      setShowAlert(true);
      setAlertMessage(
        "Please write the phone number in required format 0300-0000000"
      );
      setAlertType("error");
      return;
    }
    ...
    if (
      ...
      !isPasswordValid(signupFormData.confirmPassword)
    ) {
      setShowAlert(true);
      setAlertMessage(
        "Password must be 8-16 characters long, with at least one capital letter, one special character, and one digit."
      );
      setAlertType("error");
      return;
    }
  ...
  return (
    <>
      ...
      <div
        className={
          signupMode ? "signiu-container sign-up-mode" : "signiu-container"
        }
      >
        <div className="signiu-sliding-circle"></div>

        <div className="signiu-forms-container">
          {/* Sign in Form */}
          <div className="signiu-form-wrapper sign-in-wrapper">
            <h1 className="signiu-form-title">Sign in</h1>
            <form onSubmit={handleLoginSubmit} className="log-form">
              ...
              <button type="submit" className="signiu-submit-button">
                {" "}
                LOGIN{" "}
              </button>
            </form>
          ...
          <div className="signiu-form-wrapper sign-up-wrapper">
            <h1 className="signiu-form-title">Sign up</h1>
            ...
            <form onSubmit={handleSignupSignUp} className="log-form">
              ...
              {showSignupButton && (
                <span className="captcha-mode-btn-containers">
                  ...
                  <button
                    type="submit"
                    className="signiu-submit-button signiu-panel-button"
                  >
                    SIGNUP
                  </button>
                </span>
        ...
        <div className="signiu-panels-container">
          ...
          <div className="signiu-panel signiu-panel-left">
            <div className="signiu-panel-header">
              <h2 className="signiu-panel-title">First Time Here?</h2>
              <p className="signiu-panel-description">
                Let's Get You Started! <br />
                Begin your fashion adventure by creating an account with us.
              </p>
              <button
                className="signiu-submit-button signiu-panel-button"
          ...
          <div className="signiu-panel signiu-panel-right">
            <div className="signiu-panel-header">
              <h2 className="signiu-panel-title">Welcome Back!</h2>
              <p className="signiu-panel-description">
